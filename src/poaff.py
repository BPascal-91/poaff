...
scriptProcessing = {
    ...
    "SIA-XML":              {poaffCst.cstSpExecute:None         , poaffCst.cstSpProcessType:None,                     poaffCst.cstSpOutPath:"../output/SIA/",    poaffCst.cstSpSrcFile:"../input/SIA/20231228_AIRAC-1323_xml_SIA-FR_BPa.xml"                        ,poaffCst.cstSpSrcOwner:"https://www.sia.aviation-civile.gouv.fr"},
    "SIA-SUPAIP":           {poaffCst.cstSpExecute:not(testMode), poaffCst.cstSpProcessType:poaffCst.cstSpPtAdd,      poaffCst.cstSpOutPath:"../output/BPa/",    poaffCst.cstSpSrcFile:"../input/BPa/20231228_BPa_FR-SIA-SUPAIP_aixm45.xml"                         ,poaffCst.cstSpSrcOwner:"http://pascal.bazile.free.fr"},
    ...
    "SIA-AIXM":             {poaffCst.cstSpExecute:not(testMode), poaffCst.cstSpProcessType:poaffCst.cstSpPtAddDelta, poaffCst.cstSpOutPath:"../output/SIA/",    poaffCst.cstSpSrcFile:"../input/SIA/20231228_AIRAC-1323_aixm4.5_SIA-FR.xml"                        ,poaffCst.cstSpSrcOwner:"https://www.sia.aviation-civile.gouv.fr"},
    "EuCtrl":               {poaffCst.cstSpExecute:not(testMode), poaffCst.cstSpProcessType:poaffCst.cstSpPtAddDelta, poaffCst.cstSpOutPath:"../output/EuCtrl/", poaffCst.cstSpSrcFile:"../input/EuCtrl/20231228_AIRAC-1323_aixm4.5_Eurocontrol-Euro.xml"           ,poaffCst.cstSpSrcOwner:"https://www.eurocontrol.int"},
    "FFVL-Protocoles":      {poaffCst.cstSpExecute:not(testMode), poaffCst.cstSpProcessType:poaffCst.cstSpPtAdd,      poaffCst.cstSpOutPath:"../output/FFVL/",   poaffCst.cstSpSrcFile:"../input/FFVL/20230314_FFVL_ProtocolesParticuliers_BPa_aixm45.xml"          ,poaffCst.cstSpSrcOwner:"https://federation.ffvl.fr"},
    ...
    "BPa-ZonesComp":        {poaffCst.cstSpExecute:True         , poaffCst.cstSpProcessType:poaffCst.cstSpPtAdd,      poaffCst.cstSpOutPath:"../output/BPa/",    poaffCst.cstSpSrcFile:"../input/BPa/20230725_BPa_ZonesComplementaires_aixm45.xml"                  ,poaffCst.cstSpSrcOwner:"http://pascal.bazile.free.fr"},
    "BPa-Parcs":            {poaffCst.cstSpExecute:not(testMode), poaffCst.cstSpProcessType:poaffCst.cstSpPtAdd,      poaffCst.cstSpOutPath:"../output/Parcs/",  poaffCst.cstSpSrcFile:"../input/Parcs/__All-Parcs/20231221_All-Parcs_aixm45.xml"                   ,poaffCst.cstSpSrcOwner:"http://pascal.bazile.free.fr"},
    "LPO-Parcs":            {poaffCst.cstSpExecute:not(testMode), poaffCst.cstSpProcessType:poaffCst.cstSpPtAdd,      poaffCst.cstSpOutPath:"../output/LPO/",    poaffCst.cstSpSrcFile:"../input/LPO_Biodiv/20240101_biodiv-sports-fr_janv_Parc_aixm45.xml"         ,poaffCst.cstSpSrcOwner:"https://biodiv-sports.fr"},
    "STAC-Birds":           {poaffCst.cstSpExecute:not(testMode), poaffCst.cstSpProcessType:poaffCst.cstSpPtAdd,      poaffCst.cstSpOutPath:"../output/STAC/",   poaffCst.cstSpSrcFile:"../input/STAC/20240229_ZSM-coeur-france_aixm45.xml"                         ,poaffCst.cstSpSrcOwner:"https://www.stac.aviation-civile.gouv.fr"}
   #"LPO-Birds":            {poaffCst.cstSpExecute:not(testMode), poaffCst.cstSpProcessType:poaffCst.cstSpPtAdd,      poaffCst.cstSpOutPath:"../output/LPO/",    poaffCst.cstSpSrcFile:"../input/LPO_Biodiv/20240101_biodiv-sports-fr_janv_Zsm-Active_aixm45.xml"   ,poaffCst.cstSpSrcOwner:"https://biodiv-sports.fr"},
   #"BPa-Birds":            {poaffCst.cstSpExecute:not(testMode), poaffCst.cstSpProcessType:poaffCst.cstSpPtAdd,      poaffCst.cstSpOutPath:"../output/BPa/",    poaffCst.cstSpSrcFile:"../input/BPa/20230723_BPa_FR-ZSM_Protection-des-rapaces_aixm45.xml"         ,poaffCst.cstSpSrcOwner:"http://pascal.bazile.free.fr"},
   #"FFVP-Birds":           {poaffCst.cstSpExecute:not(testMode), poaffCst.cstSpProcessType:poaffCst.cstSpPtAdd,      poaffCst.cstSpOutPath:"../output/FFVP/",   poaffCst.cstSpSrcFile:"../input/FFVP/20230403_FFVP_BirdsProtect_aixm45.xml"                        ,poaffCst.cstSpSrcOwner:"https://www.ffvp.fr"}
}
...
def poaffMergeFiles() -> None:
    sModuleTitle = "..oooOOOO  Step 3 - Execution by - {0}  OOOOooo..".format(appId)
    ...
    oAsCat.addRefAreasInCatalogFile(partialConstruct)                       #Ajout des périmètres POAFF sous forme de zones spécifiques
    ...
    if geojsonConstruct or openairConstruct or googleMapsConstruct:
        ...
        oJsArea.addRefAreasInGlobalGeoJSON()                                    #Ajout des périmètres POAFF sous forme de zones spécifiques
...
def makeKmlFiles() -> None:
    ...
    for sTypFile in aTypeFiles:
        for sAreaKey, oAreaRef in geoRefArea.GeoRefArea(partialConstruct).AreasRef.items():
...
def poaffGenerateFileAixmAREA(sMsg:str=None) -> None:
    sModuleTitle = "..oooOOOO  Step 1 - Execution by - {0}  OOOOooo..".format(aixmParserId)
    oLog.info("\n" + sModuleTitle, outConsole=True)
    print(u"\u2594"*len(sModuleTitle))
    if sMsg!=None:
        oLog.info("{0}".format(sMsg), outConsole=True)
    oGeoRefArea = geoRefArea.GeoRefArea(partialConstruct)
    oAreasRef:dict = oGeoRefArea.AreasRef
    barre = bpaTools.ProgressBar(len(oAreasRef), 20, title="Create Aixm file with RefAreas")
    idx = 0
...
def poaffGenerateFiles(sMsg:str=None) -> None:
    sModuleTitle = "..oooOOOO  Step 2 - Execution by - {0}  OOOOooo..".format(aixmParserId)
    oLog.info("\n" + sModuleTitle, outConsole=True)
    print(u"\u2594"*len(sModuleTitle))
    if sMsg!=None:
        oLog.info("{0}".format(sMsg), outConsole=True)
...
if __name__ == '__main__':
    ...
    if aixmPaserConstruct:
        #poaffGenerateFileAixmAREA()                                         #Creation d'un fichier unique AIXM contenant l'ensemble des AREA
