...
###################################################################################################
cstPOAFFdateTrait:datetime = datetime.date(2023, 9, 13)      #bpaTools.getDateNow()  ||or||  datetime.date(2021, 5, 25)
cstAIRACdateStart:datetime = datetime.date(2023, 9, 7)
cstAIRACdateEnd:datetime   = datetime.date(2023, 10, 4)
###################################################################################################
