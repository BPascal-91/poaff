...
###################################################################################################
cstPOAFFdateTrait:datetime = datetime.date(2022, 4,  3)      #bpaTools.getDateNow()  ||or||  datetime.date(2021, 5, 25)
cstAIRACdateStart:datetime = datetime.date(2022, 3, 24)
cstAIRACdateEnd:datetime   = datetime.date(2022, 4, 20)
###################################################################################################
